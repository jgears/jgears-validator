...
public abstract class BasicValidatorTest extends ValidatorTest {
	...
	protected <T> void testNotNull(Supplier<BasicValidator<T>> withoutFieldName, Supplier<BasicValidator<T>> withFieldName, T value) {
